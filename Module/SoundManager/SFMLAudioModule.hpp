...
#ifndef SFML_AUDIO_MODULE_HPP_
    #define SFML_AUDIO_MODULE_HPP_
...
namespace modules {
    class SFMLAudioModule : public IAudioModule {
        public:
             ...
             *
             */
            inline void play() override { _sound.play(); };

            /**
             * @brief Pause the sound effect
             *
             */
            inline void pause() override { _sound.pause(); };

            /**
             * @brief Stop the sound effect
             *
             */
            inline void stop() override { _sound.stop(); };
    ...
    class SFMLMusicModule : public IMusicModule {
        public:
             ...
             *
             */
            inline void play() override { _music.play(); }
             ...
             */
            inline void setLoop(bool loop) override { _music.setLoop(loop); }
             ...
             */
            inline bool getLoop() override { return _music.getLoop(); }
